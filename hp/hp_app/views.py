...
def edit_spare(request, id):
    ...
    try:
        # Fetch the corresponding Item object based on sparePart, sparePartNo, and sparepartsize
    ...
    if request.method == 'POST':
        ...
        if item:  # If Item exists (we fetched it by matching sparepart, sparepartNo, sparepartsize)
...
def entryHistory(request):
    if request.method == 'POST':
        ...
        return redirect('inventory_inward_print',entryId=con_id)
